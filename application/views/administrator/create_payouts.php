            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo form_dropdown("assign_task_id",$assigned_task,"",' class="form-control" '); ?>

                        <span class="text-danger"><?php echo form_error('assign_task_id'); ?></span>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="paid_by" value="<?=set_value('paid_by')?>" class="form-control" placeholder="Paid By" required>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="received_by" value="<?=set_value('received_by')?>" class="form-control" placeholder="Received By" required>
                        <span class="text-danger"><?php echo form_error('received_by'); ?></span>
                    </div>
                </div>
